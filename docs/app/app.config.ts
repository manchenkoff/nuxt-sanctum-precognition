const siteName = 'Nuxt - Laravel Precognition'
...
export default defineAppConfig({
  ...
  header: {
    ...
    links: [
      ...
      },
      {
        ...
        'to': 'https://nuxt.com/modules/nuxt-sanctum-precognition',
        'target': '_blank',
  ...
  toc: {
    ...
    bottom: {
      ...
      edit: 'https://github.com/manchenkoff/nuxt-sanctum-precognition/edit/main/docs/content',
      links: [
        {
          icon: 'i-lucide-star',
